...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_path', default='/home/wuyushan/project1/st-gcn/data/Raw_Skeleton_S18-S32/RGB+D0-30000')
    parser.add_argument('--out_folder', default='/data/gty/action_dataset/ntu120_frame50')
